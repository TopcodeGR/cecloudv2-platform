...
public class MachineryRegulationDeclarationOfIncorporationTemplateParamsProvider implements TemplateParamsProvider<Doc> {
    ...
    public String getTemplateName() {
        return "machinery-regulation-declaration-of-incorporation";
    }
}
